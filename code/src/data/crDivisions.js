...
// Fuente: gist.github.com/josuenoel/80daca657b71bc1cfd95a4e27d547abe

const CR_DIVISIONS = {
  "San José": {
    "Central": ["Carmen","Merced","Hospital","Catedral","Zapote","San Francisco De Dos Rios","Uruca","Mata Redonda","Pavas","Hatillo","San Sebastián"],
    "Escazú": ["Escazú","San Antonio","San Rafael"],
    "Desamparados": ["Desamparados","San Miguel","San Juan De Dios","San Rafael Arriba","San Rafael Abajo","San Antonio","Frailes","Patarra","San Cristobal","Rosario","Damas","Gravilias","Los Guido"],
    ...
    "Goicoechea": ["Guadalupe","San Francisco","Calle Blancos","Mata De Platano","Ipís","Rancho Redondo","Purral"],
    ...
    "Vázquez De Coronado": ["San Isidro","San Rafael","Dulce Nombre De Jesus","Patalillo","Cascajal"],
    "Acosta": ["San Ignacio","Guaitil","Palmichal","Cangrejal","Sabanillas"],
    "Tibás": ["San Juan","Cinco Esquinas","Anselmo Llorente","Leon XII","Colima"],
    ...
    "Dota": ["Santa María","Jardin","Copey"],
    "Curridabat": ["Curridabat","Granadilla","Sanchez","Tirrases"],
    "Pérez Zeledón": ["San Isidro De El General","El General","Daniel Flores","Rivas","San Pedro","Platanares","Pejibaye","Cajon","Baru","Rio Nuevo","Páramo"],
    "León Cortés Castro": ["San Pablo","San Andres","Llano Bonito","San Isidro","Santa Cruz","San Antonio"],
  },
  "Alajuela": {
    "Central": ["Alajuela","San José","Carrizal","San Antonio","Guácima","San Isidro","Sabanilla","San Rafael","Rio Segundo","Desamparados","Turrucares","Tambor","Garita","Sarapiquí"],
    ...
    "Grecia": ["Grecia","San Isidro","San José","San Roque","Tacares","Rio Cuarto","Puente De Piedra","Bolivar"],
    ...
    "Sarchí": ["Sarchí Norte","Sarchí Sur","Toro Amarillo","San Pedro","Rodriguez"],
    "Upala": ["Upala","Aguas Claras","San José o Pizote","Bijagua","Delicias","Dos Rios","Yolillal","Canalete"],
  ...
  "Cartago": {
    ...
    "Paraíso": ["Paraiso","Santiago","Orosi","Cachí","Llanos de Santa Lucía"],
    "La Unión": ["Tres Rios","San Diego","San Juan","San Rafael","Concepción","Dulce Nombre","San Ramón","Rio Azul"],
  ...
  "Heredia": {
    ...
    "Santa Barbara": ["Santa Bárbara","San Pedro","San Juan","Jesús","Santo Domingo","Puraba"],
    ...
    "Belén": ["San Antonio","La Ribera","La Asuncion"],
  ...
  "Puntarenas": {
    "Central": ["Puntarenas","Pitahaya","Chomes","Lepanto","Paquera","Manzanillo","Guacimal","Barranca","Monte Verde","Isla Del Coco","Cóbano","Chacarita","Chira","Acapulco","El Roble","Arancibia"],
    "Esparza": ["Espíritu Santo","San Juan Grande","Macacona","San Rafael","San Jerónimo"],
    "Buenos Aires": ["Buenos Aires","Volcán","Potrero Grande","Boruca","Pilas","Colinas","Changuena","Biolley","Brunka"],
  ...
  "Limón": {
    "Central": ["Limón","Valle La Estrella","Rio Blanco","Matama"],
    "Pococí": ["Guapiles","Jiménez","Rita","Roxana","Cariari","Colorado","La Colonia"],
    "Siquirres": ["Siquirres","Pacuarito","Florida","Germania","El Cairo","Alegría"],
    "Talamanca": ["Bratsi","Sixaola","Cahuita","Telire"],
    "Matina": ["Matina","Batán","Carrandi"],
    "Guácimo": ["Guácimo","Mercedes","Pocora","Rio Jiménez","Duacari"],
  },
};

export default CR_DIVISIONS;
